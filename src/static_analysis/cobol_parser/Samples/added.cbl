      ...
      *///////////////////////////////////////////////////////////////
       ...
       FILE-CONTROL.
           SELECT DOGEVSAM ASSIGN TO VSAM-FILE
               ORGANIZATION IS INDEXED
               ACCESS MODE IS RANDOM
               RECORD KEY IS RECORD-ID
               FILE STATUS IS FOUND-RECORD.
       DATA DIVISION.
       FD BINFILE
      ...
      *
       ...
       PROCEDURE DIVISION.
       DECLARATIVES.
       BINFILE-CHECK SECTION.
           USE AFTER ERROR PROCEDURE ON BINFILE.
       BINFILE-STAT-CHECK.
           MOVE "XS99999" TO WK-MSG
           STRING "INVALID I-O SUBBINPF BINFILE STS=" BINFILE-STATUS
